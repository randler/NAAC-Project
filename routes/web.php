...
$this->group(['namespace' => 'Relatorio', 'middleware' => ['auth', 'check.autor', 'auth.unique.user']], function() {
    $this->get('/projetos-relatorio', 'RelatorioController@index')->name('index-relatorio');
    $this->get('/novo-relatorio/{id}', 'RelatorioController@novoRelatorio')->name('novo-relatorio');
    $this->get('/novo-relatorio/{id}', 'RelatorioController@novoRelatorio')->name('novo-relatorio');

    $this->post('salvar-relatorio', 'RelatorioController@salvarRelatorio')->name('salvar-relatorio');
});
